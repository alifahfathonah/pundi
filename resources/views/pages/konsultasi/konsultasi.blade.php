<div class="tab-pane fade m-t-40" id="konsultasi">
    ...
    @endif
    <form class="form-contact comment_form m-t-20" action="{{ route('konsultasi.konsultasi_store') }}" method="post">
        {{ csrf_field() }}
        <div class="row">
            @if (Auth::user() == null)
            <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="form-group">
                    <textarea class="form-control w-100" name="konsultasi" id="konsultasi" cols="10" rows="8" placeholder="konsultasi *" required></textarea>
                </div>
            </div>
        </div>
        <div class="form-group">
