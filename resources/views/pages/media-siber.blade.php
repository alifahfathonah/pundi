        ...
        <div class="row">
            <div class="col-lg-8 mb-5 mb-lg-0">
                <div class="blog_left_sidebar" style="text-align: justify">
                    <div>
                        <p class="f-blk fs-30 f-b">Media Siber</p>
                        <P class="text-black">Pedoman Media Siber</P>
                        <p class="text-black">
                        ...
                        <div>
                           <p class="text-black f-b700">1. Ruang Lingkup</p>
                           ...
                           <ol class="ordered-list-alpha fs-16">
                            ...
                            <ol start="4" class="ordered-list-alpha fs-16">
                            ...
                            <p class="text-black f-b700">3. Isi Buatan Pengguna (User Generated Content)</p>
                            <ol class="ordered-list-alpha fs-16">
                            ...
                            <p class="text-black f-b700">4. Ralat, Koreksi, dan Hak Jawab</p>
                            <ol class="ordered-list-alpha fs-16">
                            ...
                            <ol start="5" class="ordered-list-alpha fs-16">
                                <li>Sesuai dengan Undang-Undang Pers, media siber yang tidak melayani hak jawab dapat dijatuhi sanksi hukum pidana denda paling banyak Rp 500.000.000 (lima ratus juta rupiah).</li>
                            </ol>
                            <p class="text-black f-b700">5. Pencabutan Berita</p>
                            <ol class="ordered-list-alpha fs-16">
                            ...
                            <p class="text-black f-b700">6. Iklan</p>
                            <ol class="ordered-list-alpha fs-16">
                            ...
                            <p class="text-black f-b700">7. Hak Cipta</p>
                            <p class="text-black m-l-17">Media siber wajib menghormati hak cipta sebagaimana diatur dalam peraturan perundang-undangan yang berlaku.</p>
                            <p class="text-black f-b700">8. Pencantuman Pedoman</p>
                            <p class="text-black m-l-17">Media siber wajib mencantumkan Pedoman Pemberitaan Media Siber ini di medianya secara terang dan jelas.</p>
                            <p class="text-black f-b700">9. Sengketa</p>
