                ...
                <div class="blog_left_sidebar" style="text-align: justify">
                    <div>
                        ...
                        <ol class="ordered-list text-black fs-16">
                            ...
                            <li>Seluruh konten yang ada di dalam situs termasuk teks, video, foto, audio, ilustrasi, infografik dan lainnya dilindungi oleh undang-undang hak cipta yang dimiliki PUNDI.ID, dan atau pihak ketiga penyedia isi di situs ini.</li>
                            ...
                            <li>Pihak yang merasa dirugikan oleh artikel-artikel yang dipublish di Pundi.id bisa melayangkan protes melalui email <b>admin@pundi.or.id</b></li>
                        </ol>
                    </div>
                </div>
            </div>
